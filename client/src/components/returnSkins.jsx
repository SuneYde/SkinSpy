...
const ReturnSkins = ({ results, loadingState }) => {
  ...
  return (
    <div className={styles.container}>
      <div className={styles.header} ref={headerRef}>
        ...
        <p className={styles.head}>Suggested Price</p>
        <p className={styles.head}>Steam Price</p>
        <p className={styles.head}>Link</p>
      </div>
      <div
        className={`${styles.results} ${
          loadingState ? styles.loadingContainer : ""
        }`}
      >
        {results.length > 0 ? (
          ...
          <p className={styles.loadingText}>SkinSpy</p>
        ) : (
